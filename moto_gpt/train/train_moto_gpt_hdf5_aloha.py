...
from moto_gpt.src.trainers.moto_gpt_trainer_aloha import MotoGPT_Trainer
from torch.utils.data import DataLoader
from functools import partial
...
def main(cfg):
    ...
    if moto_gpt_config['latent_motion_pred']:
        ...
        if latent_motion_tokenizer_path is not None:
            ...
            print("Warning: latent_motion_pred is True but latent_motion_tokenizer_path is None")
            print("If you want to use latent motion prediction, please set latent_motion_tokenizer_path")
    ...
    if vq_remap is not None and latent_motion_tokenizer is not None:
    ...
    print(f"Loading dataset from {dataset_config_path} ...")
