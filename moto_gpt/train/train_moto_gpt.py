...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', type=str, default="/home/yyang-infobai/Moto/moto_gpt/configs/train/data_calvin-model_actPredFalse_motionPredTrue_visionMaeLarge_seq2_chunk5_maskProb0.5-train_lr0.0001_bs512-aug_shiftTrue_resizedCropFalse.yaml")
