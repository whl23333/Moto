...
from moto_gpt.src.trainers.moto_gpt_trainer import MotoGPT_Trainer, MotoGPT_Trainer_Metaworld
from torch.utils.data import DataLoader
from functools import partial
from common.data.data_utils import load_dataset
from common.data.datasets import MetaworldDataset
...
def main(cfg):
    ...
    metaworld_dataset = MetaworldDataset(
    ...
    # Prepare Trainer
    trainer = MotoGPT_Trainer_Metaworld(
        moto_gpt=moto_gpt,
