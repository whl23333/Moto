...
class Arguments(tap.Tap):
    ...
    # MotoGPT model parameters
    moto_gpt_config_path: Path = "configs/moto_gpt.yaml"
    latent_motion_tokenizer_path: Optional[Path] = None
    vq_remap: Optional[str] = None
    unknown_index: Optional[str] = None


def load_models(args):
    
    moto_gpt_config_path = args.moto_gpt_config_path
    ...
    if moto_gpt_config['latent_motion_pred']:
        latent_motion_tokenizer_path = args.latent_motion_tokenizer_path
    ...
    print(f"loading model weight of Moto-GPT from {resume_ckpt_path} ...")
