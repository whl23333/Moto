...
accelerate launch --main_process_port 29502 evaluate_calvin.py \
...
MLMP=1.0
TEST_CHUNK_SIZE=8
MOTO_GPT_PATH="${PROJECT_ROOT}/moto_gpt/outputs/moto_gpt_finetuned_on_calvin/paired_lm4_10_pt_3/saved_epoch_5_step_83730"
EVAL_DIR="${PROJECT_ROOT}/moto_gpt/evaluation/robot_manipulation_benchmarks/calvin/eval_results/paired_lm4_10_pt_3/saved_epoch_5_step_83730"
EvalCALVIN
